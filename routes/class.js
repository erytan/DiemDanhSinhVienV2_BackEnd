...
const { verifyAccessToken, isAdmin, validateClassCreation, validateClassCreation1,checkAccountStatus } = require('../middlewares/verifyToken')
...
router.get("/getClassByUser", [verifyAccessToken,checkAccountStatus], ctrls.getClassByUserInClass)
